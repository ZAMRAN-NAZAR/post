...
const Register = () => {
    ...
    return (
        <div className="w-1/2 mx-auto mt-20 rounded-xl shadow-2xl">
            ...
            <form className="px-10 py-10" onSubmit={submit}>
                ...
                />
                {errors.username && (
                    <div className="pt-2 text-red-500">{errors.username}</div>
                )}
                ...
                />
                {errors.password && (
                    <div className="pt-2 text-red-500">{errors.password}</div>
                )}
